...
<div class="movie-card">
    ...
    ${index % 3==0 ? '<div class="top-badge">TOP 10</div>' : ''} <!-- Show TOP 10 only for the first 10 movies -->
</div>
...
async function fetchMovies() {
    try {
        ...
        data.results.forEach((movie, index) => {
            ...
            movieCard.innerHTML =MOVIE_CARD(movie,index);
