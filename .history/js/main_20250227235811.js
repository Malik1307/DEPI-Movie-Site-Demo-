...
async function loadAllMediaRows() {
  ...
  container.appendChild(
    createMediaRow("Trending Movies", trendingMovies.results)
  );
  container.appendChild(
    createMediaRow("Now Playing", nowPlayingMovies.results)
  );
  container.appendChild(
    createMediaRow("Upcoming Movies", upcomingMovies.results)
  );
  ...
  // Add TV rows
  container.appendChild(
    createMediaRow("Trending TV Shows", trendingTV.results)
  );
