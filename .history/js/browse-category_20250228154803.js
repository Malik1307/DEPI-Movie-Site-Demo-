...
async function fetchingBrowseCategory(filters = {}) {
  ...
  // Handle genres for different media types
  if (category === "anime") {
    // For anime, always include Animation genre (16) and add any other selected genres
    if (filters.genres && filters.genres.length > 0) {
      // Add animation genre (16) if not already included
